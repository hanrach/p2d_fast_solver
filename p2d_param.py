...
def get_battery_sections(Np, Nn, Mp, Ms, Mn, Ma, Mz,delta_t):
    ...
    accq = CurrentCollectorEquation(a_cc_constants(),cc_grid_param(Ma),delta_t)
    zccq = CurrentCollectorEquation(z_cc_constants(),cc_grid_param(Mz),delta_t)
